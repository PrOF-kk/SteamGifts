        ...
        switch (subview) {
            ...
            case MAIN_GIVEAWAY_1:
                ...
                for (int id : new int[]{
                        ...
                        R.id.giveaway_list_indicator_cards, R.id.giveaway_list_indicator_dlc, R.id.giveaway_list_indicator_limited, R.id.giveaway_list_indicator_delisted, R.id.giveaway_list_indicator_bundle
                }) {
